      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 md:px-8">
        <div className="mb-12 flex flex-col items-center gap-4 text-center md:mb-16">
          ...
          <h2 className="text-[clamp(1.4rem,5.5vw,2rem)] md:text-[clamp(1.75rem,3vw,2.75rem)]">
            <CollageTitle text={t.quotes.title} />
          </h2>
        </div>
        ...
        <div className="flex flex-col gap-8 md:gap-10">
          {t.quotes.items.map((q, i) => (
            <motion.blockquote
              ...
              className={`torn-edge paper-shadow mx-auto w-full max-w-2xl px-8 py-7 md:px-10 md:py-8 ${variants[i % variants.length]} ${
